        ...
        <div class="row">
            <div class="barra-lateral col-12 col-sm-auto">
                <nav class="Menu d-flex d-sm-block justify-content-center flex-wrap">
                    <a href="Menu.php" class="active"><i class="bi bi-house"></i><span>INICIO</span></a>
                    <a href="MISCASOS.php"><i class="bi bi-briefcase"></i><span>MIS CASOS</span></a>
                    <a href="CALENDARIO.php"><i class="bi bi-calendar3"></i><span>CALENDARIO</span></a>
                    <a href="CONTACTAR.php"><i class="bi bi-chat-right-dots"></i><span>CONTACTAR</span></a>
                </nav>
            </div>
