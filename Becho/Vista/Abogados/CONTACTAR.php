...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <li><a href="Menu.php" ><span class="bi bi-house"></span><span>INICIO</span></a></li>
                ...
                <li><a href="CONTACTAR.php" class="active"><span class="bi bi-chat-right-dots"></span><span>CONTACTAR</span></a></li>
            </ul>
        </div>
    </div>
    <!--CONTENIDO-->
