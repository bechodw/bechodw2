        ...
        <div class="row">
            <div class="barra-lateral col-12 col-sm-auto">
                <nav class="Menu d-flex d-sm-block justify-content-center flex-wrap">
                    ...
                    <a href="MISCASOS.php" class="active"><i class="fa-sharp fa-solid fa-folder-tree"></i><span>MIS CASOS</span></a>
                    <a href="CALENDARIO.php"><i class="fa-sharp fa-solid fa-calendar-day"></i><span>CALENDARIO</span></a>
